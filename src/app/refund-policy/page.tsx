    ...
    <div className="min-h-screen bg-white pt-20 sm:pt-28 pb-8 sm:pb-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-black mt-6 sm:mt-8 mb-3 sm:mb-4">Returns</h2>
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-black mt-6 sm:mt-8 mb-3 sm:mb-4">Refunds</h2>
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-black mt-6 sm:mt-8 mb-3 sm:mb-4">Exchanges</h2>
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-black mt-6 sm:mt-8 mb-3 sm:mb-4">Non-Returnable Items</h2>
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-black mt-6 sm:mt-8 mb-3 sm:mb-4">Damaged or Defective Items</h2>
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-black mt-6 sm:mt-8 mb-3 sm:mb-4">Return Shipping</h2>
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-black mt-6 sm:mt-8 mb-3 sm:mb-4">Processing Time</h2>
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
