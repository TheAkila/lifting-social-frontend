...
export default function ProductReviews({ productId, productName }: ProductReviewsProps) {
  ...
  return (
    <div className="py-12">
      {/* Reviews Header */}
      <div className="mb-8">
        <h2 className="font-display font-bold text-3xl text-zinc-900 mb-6">
          Customer Reviews
        </h2>
        ...
        {stats && stats.totalReviews > 0 ? (
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            {/* Overall Rating */}
            <div className="bg-zinc-50 rounded-[12px] p-6">
              <div className="text-center mb-4">
                <div className="text-5xl font-display font-bold text-zinc-900 mb-2">
            ...
            <div className="space-y-2">
              {[5, 4, 3, 2, 1].map((rating) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-zinc-600 min-w-[45px] text-right">
          ...
          <div className="bg-zinc-50 rounded-[12px] p-8 text-center mb-8">
            <Star className="w-12 h-12 text-zinc-400 mx-auto mb-3" />
            <p className="text-zinc-600">No reviews yet. Be the first to review this product!</p>
          </div>
        )}
        ...
        {user && !userReview && (
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 bg-zinc-900 hover:bg-zinc-800 text-white font-medium rounded-[8px] transition-colors"
          >
            Write a Review
          </button>
        )}
        ...
        {userReview && (
          <div className="bg-blue-50 border border-blue-200 rounded-[12px] p-6 mb-6">
            <div className="flex items-start justify-between mb-3">
              <div>
                <p className="text-sm font-medium text-blue-900 mb-2">Your Review</p>
                <StarRating rating={userReview.rating} readonly />
              </div>
              <div className="flex gap-2">
                <button
                  onClick={() => setShowReviewForm(true)}
                  className="p-2 hover:bg-blue-100 rounded-[8px] transition-colors"
            ...
            <h4 className="font-semibold text-zinc-900 mb-2">{userReview.title}</h4>
            <p className="text-zinc-700 text-sm">{userReview.comment}</p>
        ...
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-zinc-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="text-sm border border-zinc-200 rounded-[8px] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-accent"
            >
        ...
        <AnimatePresence mode="popLayout">
          {reviews.map((review, index) => (
            <motion.div
              ...
              className="bg-white border border-zinc-200 rounded-[12px] p-6"
            >
              {/* Review Header */}
              <div className="flex items-start justify-between mb-3">
                <div>
              ...
              {/* Review Content */}
              <h4 className="font-semibold text-zinc-900 mb-2">{review.title}</h4>
